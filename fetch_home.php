...
$date= date("d-m-y");
$sqluser ="SELECT * FROM tbl_petients ";
                 $retrieve = mysqli_query($db,$sqluser);
                $patients = mysqli_num_rows($retrieve);
				
				 $sql ="SELECT * FROM tbl_petients WHERE Gender='Female' ";
	            ...
	            {   
              	   $dob= $found['DOB'];
			                 ...
			                 $todayyear='20'.$year;   // current year 
			              
			                 $bornmnth= substr($dob,5,2); //Born month			   
				...
				$sql ="SELECT * FROM tbl_petients WHERE  Gender='Male' ";
                 $retr = mysqli_query($db,$sql);
				 //$tcount1=0;$tcount2=0;$tcount3=0;$tcount4=0;$tcount5=0;$tcount6=0;$tcount7=0;
				 $males=0;
				while($found = mysqli_fetch_array($retr))
...
<div class="row-one widgettable">
			<div class="col-md-7 content-top-2 card" style="width:70%;height: 100%">
