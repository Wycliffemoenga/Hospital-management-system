...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse" >
          <div class="navbar-header">
			...
			<center>	
				<img src="img/logo.jpg"  style="margin-top:20px;width:90px;border-radius:100%">
			</center>	   
                           </div>
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="mailto:homelandtechnologies75@gmail.com" target="">Design and Developed by Homeland Technologies.</a></p>		
	</div>
    <!--//footer-->
	</div>
