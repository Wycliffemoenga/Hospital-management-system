...
<nav class="navbar navbar-inverse" style="margin-top:5px;background-color:white">
    <div class="container-fluid">
     <div class="banner">
<div style="position:center;color:blue;margin-left:340px;margin-bottom:50px;margin-top:20px;font-size:30px;font-family:Dr Mlombe;">NAROK DISTRICT HOSPITAL</div>
                    <center><img src="img/logo.jpg"  style="position:center;margin-top:-5%;border-radius:100%;width:90px"></center>
